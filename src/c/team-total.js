                ...
                m('.w-row', [
                    ...
                    m('.w-col.w-col-8', [
                        m('.fontsize-base.u-marginbottom-30',
                                ...
                                } countries (${teamTotal.countries.toString()})! Trend is independent, open-source, and built with love. Our passion is to build an environment where more and more projects can.`),
                        m('.fontsize-larger.lineheight-tight.text-success',
                                `Our team, together, has already R$${h.formatNumber(teamTotal.total_amount)} for ${teamTotal.total_contributed_projects} home!`)
                    ]),
                    m('.w-col.w-col-2')
                ])
            ]))
