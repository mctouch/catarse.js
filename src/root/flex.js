        ...
        return [
            m('.w-section.hero-full.hero-zelo', [
                m('.w-container.u-text-center', [
                    ...
                    m('.w-row', [
                        m('.w-col.fontsize-large.u-marginbottom-60.w-col-push-2.w-col-8', /'Let's build a new mode of crowdfunding! Register your email and learn how to register your project in flex!'/)
                    ]),
                    m('.w-row', [
                        m('.w-col.w-col-2'),
                ...
                m('.section', [
                        ...
                        m('.fontsize-largest.u-margintop-40.u-text-center', 'Pra quem será?'), m('.fontsize-base.u-text-center.u-marginbottom-60', 'We will start the testing phase with specific project categories'), m('div', [
                            m('.w-row.u-marginbottom-60', [
                                m('.w-col.w-col-6', [
                                    ...
                                    ]), m('p.fontsize-base', 'Simple campaigns that need the flexibility to raise money with people close to you. We will be open to a variety of personal campaigns that can range from covering study costs to helping those in need of medical treatment. To collect the money to make that party to buy gifts for someone with the help of the galley. ')
                                ])
                            ])
                        ])
                    ])
                    ...
                    m('.w-container', [
                        m('.fontsize-largest.u-margintop-40.u-marginbottom-60.u-text-center', 'How it will work?'), m('.w-row.u-marginbottom-40', [
                            m('.w-col.w-col-6', [
                                m('.u-text-center', [
                            ...
                            m('.w-col.w-col-6', [
                                ...
                                ]), m('.fontsize-large.u-marginbottom-10.u-text-center.fontweight-semibold', 'You publish your project yourself'), m('p.u-text-center.fontsize-base', 'All projects enrolled in the flex go into the air. Agility and ease for you to get resources through the internet.')
                            ]), m('.w-col.w-col-6', [
                                m('.u-text-center', [
                                    m('img[src=\'https://daks2k3a4ib2z.cloudfront.net/54b440b85608e3f4389db387/560e39e77c013d4a3ee687d4_icon-time.png\'][width=\'180\']')
                                ]), m('.fontsize-large.u-marginbottom-10.u-text-center.fontweight-semibold', 'End the campaign anytime'), m('p.u-text-center.fontsize-base', 'There is no capitation time limit. You choose when you close your campaign and receive the amounts collected.')
                            ])
                        ])
                    ])
                ]),
                        ...
                        m('.fontsize-larger.u-text-center.u-marginbottom-60.u-margintop-40', 'Doubts'), m('.w-row.u-marginbottom-60', [
                            m('.w-col.w-col-6', [
                                m.component(landingQA, {
                                    ...
                                    answer: 'At Trend, sending a project costs nothing! The fee charged on the Trend flex service is 13% on the amount collected.'
                                }),
                                m.component(landingQA, {
                                    question: 'Where does the money from my project come from??',
                                    answer: 'Family, friends, fans and members of communities that you are part of are your greatest contributors. It is they who will spread your campaign to the people they know, and so the circle of supporters grows and your campaign gains strength.'
                                }),
                                m.component(landingQA, {
                                    question: 'What is the difference between the flexible and the "all or nothing""?',
                                    answer: 'Currently Trend only uses the "all or nothing" model, where you only get the money if you beat the collection goal within the term of the campaign. The flexible model is different because it allows the director to keep what he has collected, regardless of whether or not he reaches the project goal within the term of the campaign. There will be no time limit for campaigns. Our flexible system will be something new compared to the models that currently exist in the market.'
                                }),
                            ]), m('.w-col.w-col-6', [
                                m.component(landingQA, {
                                    question: 'I can register projects for the flexible modality already?',
                                    answer: 'Yes. Register your email and learn how to register your project in flex.!'
                                }),
                                m.component(landingQA, {
                                    question: 'Why should you want to do the Trend flex?',
                                    answer: 'We believe that the Fashion crowdfunding environment still has room for many actions, tests and experiments to really understand what people need. We dream of making collective financing a habit in for true talent. Trend flex is another step in this direction.'
                                }),
                                m.component(landingQA, {
                                    question: 'When will you launch the Trend flex?',
                ...
                m('.w-section.section-large.u-text-center.bg-purple', [
                    m('.w-container.fontcolor-negative', [
                        m('.fontsize-largest', 'Enter your project!'), m('.fontsize-base.u-marginbottom-60', 'Register your email and learn how to register your project in flex!'), m('.w-row', [
                            m('.w-col.w-col-2'),
                            m.component(landingSignup, {
                                builder: ctrl.builder
                            }),
                    ...
                    m('.w-container.u-text-center', [
                        m('.w-editable.u-marginbottom-40.fontsize-larger.lineheight-tight.fontcolor-negative', /'Flex is an experiment and initiative of Trend, Fashion's largest crowdfunding platform.'/),
                        m('.w-row.u-text-center', (ctrl.statsLoader()) ? h.loader() : [
                            m('.w-col.w-col-4', [
                                m('.fontsize-jumbo.text-success.lineheight-loose', h.formatNumber(stats.total_contributors, 0, 3)), m('p.start-stats.fontsize-base.fontcolor-negative', 'People have already supported at least 01 project in Trend')
                            ]),
                            m('.w-col.w-col-4', [
                                m('.fontsize-jumbo.text-success.lineheight-loose', h.formatNumber(stats.total_projects_success, 0, 3)), m('p.start-stats.fontsize-base.fontcolor-negative', 'Projects have already been funded in Trend')
                            ]),
                            m('.w-col.w-col-4', [
                                m('.fontsize-jumbo.text-success.lineheight-loose', `${stats.total_contributed.toString().slice(0, 2)} milhões`), m('p.start-stats.fontsize-base.fontcolor-negative', 'They were invested in ideas published in Trend')
                            ])
                        ])
                    ])
                ]),
                m('.w-section.section.bg-blue-one.fontcolor-negative', [
                    m('.w-container', [
                        m('.fontsize-large.u-text-center.u-marginbottom-20', 'Recommend the Trend flex for friends! '),
                        m('.w-row', [
                            m('.w-col.w-col-2'),
                            m('.w-col.w-col-8', [
                                m('.w-row', [
                                    m('.w-col.w-col-6.w-col-small-6.w-col-tiny-6.w-sub-col-middle', [
                                        m('div', [
                                            ...
                                            m(`a.w-button.btn.btn-large.btn-fb[href="http://www.facebook.com/sharer/sharer.php?u=https://www.catarse.me/flex?ref=facebook&title=${encodeURIComponent('Meet the new Catarse Flex!')}"][target="_blank"]`, 'To share')
                                        ])
                                    ]),
                                    m('.w-col.w-col-6.w-col-small-6.w-col-tiny-6', [
                                        m('div', [
                                            ...
                                            m(`a.w-button.btn.btn-large.btn-tweet[href="https://twitter.com/intent/tweet?text=${encodeURIComponent(/'Let's build a new mode of crowdfunding for Catarse! Join us, sign up for your email!'/)}https://www.catarse.me/flex?ref=twitter"][target="_blank"]`, 'Tuitar')
                                        ])
                                    ])
                                ])
                            ]),
